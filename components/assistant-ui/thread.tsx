...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root
      className="aui-assistant-message-root slide-in-from-bottom-1 relative mx-auto w-full max-w-(--thread-max-width) pt-4"
      data-role="assistant"
    >
